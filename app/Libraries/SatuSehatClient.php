...
class SatuSehatClient
{
    ...
    public function __construct(?array $override = null)
    {
        ...
        $official = $this->environment === 'production'
            ? ['oauth' => 'https://api-satusehat.kemkes.go.id/oauth2/v1', 'fhir' => 'https://api-satusehat.kemkes.go.id/fhir-r4/v1']
            : ['oauth' => 'https://api-satusehat-stg.dto.kemkes.go.id/oauth2/v1', 'fhir' => 'https://api-satusehat-stg.dto.kemkes.go.id/fhir-r4/v1'];
